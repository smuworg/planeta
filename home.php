...
<!--                                </span>-->
    ...
    <div class="category-box__heading">
        <a href="" class="category-box__category-title">Najpopularniejsze</a>
    ...
    <div class="category-box-wrapper">
        <?php get_template_part('category-box--eq'); ?>
    </div>
    ...
    <div class="category-box-wrapper">
        <div class="category-box__heading">
            <a href="" class="category-box__category-title">Longi</a>
            <a href="" class="category-box__show-all">Zobacz wszystkie</a>
        </div>
        <?php get_template_part('category-box--long'); ?>
    </div>
